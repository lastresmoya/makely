                        ...
                        <div className="card shadow-sm">
                            ...
                            <div className="card-body message-box">
                                ...
                                <div className="d-flex align-items-start mb-4">
                                    ...
                                    <div className="px-3 pt-3 pb-4 ml-3 mr-5 bg-light-secondary card shadow-sm border-0">
                                ...
                                {/* Me Mark */}
                                <div className="d-flex align-items-start mb-4">
                                    <div className="px-3 pt-3 pb-4 mr-3 ml-5 bg-light card shadow-sm border-0">
